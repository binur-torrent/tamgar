...
const products = [
  ['РАБОЧАЯ ОДЕЖДА', 'Летние и утепленные полукомбинезоны, рабочие куртки, халаты, жилеты и фартуки.', 'Frame 20.png'],
  ['СПЕЦОДЕЖДА И СИЗ', 'Костюмы сварщика, защита от повышенных температур и кислот, сигнальная одежда, влагозащита.', 'Frame 21.png'],
  ['МЕДИЦИНСКАЯ ОДЕЖДА', 'Хирургические и процедурные костюмы, халаты, одежда для скорой помощи, шапочки, маски.', 'Frame 22.png'],
  ['ПОСТЕЛЬНОЕ БЕЛЬЕ', 'B2B-комплекты для отелей, больниц и общежитий.', 'Frame 23.png'],
  ['ПОСТЕЛЬНЫЕ ПРИНАДЛЕЖНОСТИ', 'Матрасы (в т.ч. влагонепроницаемые/медицинские), подушки, одеяла, наматрасники, покрывала.', 'Frame 24.png'],
  ['КОРПОРАТИВНАЯ ОДЕЖДА', 'Форма для поваров, официантов, клининга, администраторов и промо-персонала.', 'Frame 25.png'],
  ['ОДЕЖДА ДЛЯ ОХРАННЫХ СТРУКТУР', 'Форменные костюмы, камуфляж, разгрузочные жилеты, сорочки.', 'Frame 26.png'],
  ['ТРИКОТАЖНЫЕ ИЗДЕЛИЯ', 'Футболки, поло, толстовки, термобелье и подшлемники собственного пошива.', 'Frame 27.png'],
  ['МАХРОВЫЙ ТЕКСТИЛЬ', 'Махровые и вафельные полотенца, скатерти, салфетки, поварские кители.', 'Frame 28.png'],
];
